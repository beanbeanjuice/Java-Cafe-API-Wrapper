...
public class RaffleTest {
    ...
    public void rafflesAPITest() {
        ...
        Assertions.assertTrue(cafeAPI.RAFFLE.deleteRaffle("817975989547040795", "878895791081676831"));

        // Makes sure a raffle can be created.
        Assertions.assertTrue(() -> cafeAPI.RAFFLE.createRaffle("817975989547040795", new Raffle(
                "878895791081676831",
                currentTimestamp,
                3
        )));
        ...
        Assertions.assertThrows(ConflictException.class, () -> cafeAPI.RAFFLE.createRaffle("817975989547040795", new Raffle(
                "878895791081676831",
                currentTimestamp,
                3
        )));
        ...
        Assertions.assertTrue(() -> {
            ArrayList<Raffle> raffles = cafeAPI.RAFFLE.getAllRaffles().get("817975989547040795");
        ...
        Assertions.assertTrue(() -> {
            ArrayList<Raffle> raffles = cafeAPI.RAFFLE.getGuildRaffles("817975989547040795");

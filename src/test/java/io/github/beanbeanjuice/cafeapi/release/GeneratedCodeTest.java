...
public class GeneratedCodeTest {
    ...
    public void testGeneratedCodesAPI() {
        ...
        Assertions.assertTrue(cafeAPI.GENERATED_CODE.deleteUserGeneratedCode("817975989547040795"));

        // Makes sure a NotFoundException is thrown when trying to search for a user that doesn't exist.
        Assertions.assertThrows(NotFoundException.class, () -> cafeAPI.GENERATED_CODE.getUserGeneratedCode("817975989547040795"));

        // Makes sure a generated code can be created.
        Assertions.assertTrue(cafeAPI.GENERATED_CODE.createUserGeneratedCode("817975989547040795", "testCode"));

        // Makes sure a duplicate code can't be created.
        Assertions.assertThrows(ConflictException.class, () -> cafeAPI.GENERATED_CODE.createUserGeneratedCode("817975989547040795", "testCod#"));

        // Makes sure the code retrieved is the one entered.
        Assertions.assertEquals("testCode", cafeAPI.GENERATED_CODE.getAllGeneratedCodes().get("817975989547040795"));

        // Makes sure the code retrieved from the hashmap is the one entered.
        Assertions.assertEquals("testCode", cafeAPI.GENERATED_CODE.getUserGeneratedCode("817975989547040795"));

        // Makes sure the generated code can be updated.
        Assertions.assertTrue(cafeAPI.GENERATED_CODE.updateUserGeneratedCode("817975989547040795", "bruh_moment"));

        // Makes sure the retrieved generated code is the same as the one entered.
        Assertions.assertEquals("bruh_moment", cafeAPI.GENERATED_CODE.getUserGeneratedCode("817975989547040795"));

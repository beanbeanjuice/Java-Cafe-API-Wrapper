...
public class GuildWelcomeTest {
    ...
    public void guildWelcomesAPITest() {
        ...
        Assertions.assertTrue(cafeAPI.WELCOME.deleteGuildWelcome("817975989547040795"));

        // Creates a new guild welcome.
        Assertions.assertTrue(cafeAPI.WELCOME.createGuildWelcome(new GuildWelcome(
                "817975989547040795",
        ...
        Assertions.assertTrue(() -> {
            for (GuildWelcome welcome : cafeAPI.WELCOME.getAllGuildWelcomes()) {
        ...
        Assertions.assertEquals(
                "Welcome, {user} to the bot testing server!\\nI hope you enjoy your stay! :heart:\\nMake sure to...\\n Check out #polls,\\nCheck out #logger,\\n and Check out #cafebot-beta-log!",
                cafeAPI.WELCOME.getGuildWelcome("817975989547040795").getDescription());
        ...
        Assertions.assertTrue(() -> {
            GuildWelcome currentGuildWelcome = cafeAPI.WELCOME.getGuildWelcome("817975989547040795");

...
public class Words implements CafeAPI {
     ...
     * @param apiKey The API key to use for connection and verification to the {@link cafeapi.CafeAPI CafeAPI}.
     */
    ...
    /**
     * Gets an {@link ArrayList} of {@link Word} from the {@link cafeapi.CafeAPI CafeAPI}.
     * @return The {@link ArrayList} of {@link Word} from the {@link cafeapi.CafeAPI CafeAPI}.
    ...
    /**
     * Gets a {@link Word} in the {@link cafeapi.CafeAPI CafeAPI}.
     * @param word The {@link String word} to get.
     * @return The {@link Word} from the {@link cafeapi.CafeAPI CafeAPI}.
    ...
    /**
     * Updates a {@link Word} in the {@link cafeapi.CafeAPI CafeAPI}.

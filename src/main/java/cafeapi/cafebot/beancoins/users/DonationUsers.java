package cafeapi.cafebot.beancoins.users;
...
/**
 * A class used to make {@link DonationUsers} requests to the {@link cafeapi.CafeAPI CafeAPI}.
 *
...
public class DonationUsers implements CafeAPI {
    ...
    /**
     * Retrieves all {@link Timestamp} from the {@link cafeapi.CafeAPI CafeAPI} containing when a specified {@link String userID} can be donated to again.
     ...
     * @return True, if the {@link Timestamp timeUntilNextDonation} was successfully created in the {@link cafeapi.CafeAPI CafeAPI}.
     * @throws AuthorizationException Thrown when the {@link String apiKey} is invalid.
     * @throws ResponseException Thrown when there is a generic server-side {@link CafeException}.

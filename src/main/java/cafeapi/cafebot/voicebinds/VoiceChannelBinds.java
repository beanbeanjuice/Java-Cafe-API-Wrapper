package cafeapi.cafebot.voicebinds;
...
/**
 * A class used for {@link VoiceChannelBinds} requests in the {@link cafeapi.CafeAPI CafeAPI}.
 *
...
public class VoiceChannelBinds implements CafeAPI {
    ...
    /**
     * Gets all {@link VoiceChannelBind} in the {@link cafeapi.CafeAPI CafeAPI}.
    ...
    /**
     * Adds a {@link VoiceChannelBind} for a Discord server in the {@link cafeapi.CafeAPI CafeAPI}.
     * @param guildID The {@link String guildID} of the Discord server.
    ...
    /**
     * Deletes a {@link VoiceChannelBind} from the {@link cafeapi.CafeAPI CafeAPI}.
     * @param guildID The {@link String guildID} of the Discord server.

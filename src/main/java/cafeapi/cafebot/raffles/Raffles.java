...
/**
 * A class used for requests about {@link Raffles} in the {@link cafeapi.CafeAPI CafeAPI}.
 *
...
public class Raffles implements CafeAPI {
    ...
    /**
     * Creates the {@link Raffles} module for the {@link cafeapi.CafeAPI CafeAPI}.
    ...
    /**
     * Retrieves all {@link Raffle Raffles} in the {@link cafeapi.CafeAPI CafeAPI}.
    ...
    throws AuthorizationException, ResponseException {
        ...
        for (JsonNode raffle : request.getData().get("raffles")) {
            ...
            Timestamp endingTime = Generic.parseTimestamp(raffle.get("ending_time").asText());
     ...
     * @return The {@link ArrayList} of {@link Raffle} in the {@link cafeapi.CafeAPI CafeAPI}.
     * @throws AuthorizationException Thrown when the {@link String apiKey} is invalid.
     * @throws ResponseException Thrown when there is a generic server-side {@link cafeapi.exception.CafeException CafeException}.
     */
    @NotNull
    ...
    /**
     * Creates a new {@link Raffle} in the {@link cafeapi.CafeAPI CafeAPI}.
     * @param guildID The {@link String guildID} of the {@link Raffle}.
     * @param raffle The {@link Raffle} to add to the {@link cafeapi.CafeAPI CafeAPI}.
    ...
    /**
     * Deletes a {@link Raffle} from the {@link cafeapi.CafeAPI CafeAPI}.
     * @param guildID The {@link String guildID} of the {@link Raffle}.
     * @param raffle The {@link Raffle} to delete from the {@link cafeapi.CafeAPI CafeAPI}.
     * @return True, if the {@link Raffle} was successfully removed from the {@link cafeapi.CafeAPI CafeAPI}.
     * @throws AuthorizationException Thrown when the {@link String apiKey} is invalid.
     * @throws ResponseException Thrown when there is a generic server-side {@link cafeapi.exception.CafeException CafeException}.
     * @throws UndefinedVariableException Thrown when a variable is undefined.
     */

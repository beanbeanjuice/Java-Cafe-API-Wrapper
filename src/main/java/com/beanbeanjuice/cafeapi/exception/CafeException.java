...
/**
 * A generic {@link RuntimeException} used for {@link com.beanbeanjuice.cafeapi.CafeAPI CafeAPI} exceptions.
 *
...
public class CafeException extends RuntimeException {
    ...
    /**
     * @return The {@link Integer statusCode} from the {@link com.beanbeanjuice.cafeapi.requests.Request Request} that threw the {@link CafeException}.
     */
    @NotNull
    ...
    /**
     * @return The {@link String message} from the {@link com.beanbeanjuice.cafeapi.requests.Request Request} that threw the {@link CafeException}.
     */
    @NotNull
    @Override

...
/**
 * A class used for handling {@link GeneratedCodes} {@link Request Requests} for the {@link com.beanbeanjuice.cafeapi.CafeAPI CafeAPI}.
 *
...
public class GeneratedCodes implements CafeAPI {
    ...
    /**
     * Retrieves all {@link String generatedCode} from the {@link com.beanbeanjuice.cafeapi.CafeAPI CafeAPI}.
     ...
     * @return True, if the {@link String generatedCode} was successfully updated in the {@link com.beanbeanjuice.cafeapi.CafeAPI CafeAPI}.
     * @throws AuthorizationException Thrown when the {@link String apiKey} is invalid.
     * @throws ResponseException Thrown when there is a generic server-side {@link CafeException}.
